...
export default function Pong() {
	...
	const startOnline = (
		...
		try {
			...
			console.error('Error in startOnline:', error);
		}
		setPlay(true);
	};
			...
			<div className="relative w-screen h-screen flex items-center justify-center">
				...
				{!play && mode === null && (
					<div className="flex flex-col sm:flex-row items-center justify-center gap-8 w-full h-full">
						<ActionButton
							color="gray"
							icon={<div className="w-6 h-6 bg-gray-500 rounded-full"></div>}
							title="Offline"
						...
						<ActionButton
							color="cyan"
							icon={<div className="w-6 h-6 bg-cyan-500 rounded-full"></div>}
							title="Online"
