							...
							<div className="flex-1 text-center md:text-left">
								...
								<div className="flex flex-wrap gap-3 justify-center md:justify-start mt-4">
									<div className="bg-slate-700/50 dark:bg-slate-700/50 border border-slate-600 dark:border-slate-600 rounded-lg px-4 py-2 flex items-center gap-2">
										...
										<div>
											<div className="text-xs text-gray-400 dark:text-gray-400 uppercase font-bold">
												{t("profileView.tournaments")}
											</div>
											<div className="text-white dark:text-white font-bold">
						...
						{activeTab === "overview" && (
							<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 animate-fadeIn">
								<div className="bg-gradient-to-br from-blue-900/40 to-slate-900/40 dark:from-blue-900/40 dark:to-slate-900/40 border border-blue-500/20 dark:border-blue-500/20 rounded-2xl p-6 text-center shadow-xl">
									<div className="text-blue-400 dark:text-blue-400 mb-2 font-medium uppercase tracking-wider text-sm">
										{t("profileView.overview.totalGames")}
									</div>
									<div className="text-5xl font-black text-white dark:text-white">
										{stats.totalGames}
									</div>
								</div>
								<div className="bg-gradient-to-br from-green-900/40 to-slate-900/40 dark:from-green-900/40 dark:to-slate-900/40 border border-green-500/20 dark:border-green-500/20 rounded-2xl p-6 text-center shadow-xl">
									<div className="text-green-400 dark:text-green-400 mb-2 font-medium uppercase tracking-wider text-sm">
										{t("profileView.overview.wins")}
									</div>
									<div className="text-5xl font-black text-white dark:text-white">
										{stats.wins}
									</div>
								...
								<div className="bg-gradient-to-br from-red-900/40 to-slate-900/40 dark:from-red-900/40 dark:to-slate-900/40 border border-red-500/20 dark:border-red-500/20 rounded-2xl p-6 text-center shadow-xl">
									<div className="text-red-400 dark:text-red-400 mb-2 font-medium uppercase tracking-wider text-sm">
										{t("profileView.overview.losses")}
									</div>
									<div className="text-5xl font-black text-white dark:text-white">
										{stats.losses}
									</div>
								...
								<div className="bg-gradient-to-br from-yellow-900/40 to-slate-900/40 dark:from-yellow-900/40 dark:to-slate-900/40 border border-yellow-500/20 dark:border-yellow-500/20 rounded-2xl p-6 text-center shadow-xl">
									<div className="text-yellow-400 dark:text-yellow-400 mb-2 font-medium uppercase tracking-wider text-sm">
										{t("profileView.overview.winRate")}
									</div>
									<div className="text-5xl font-black text-white dark:text-white">
										{stats.winRate}%
									</div>
							...
							<div className="bg-slate-800/60 dark:bg-slate-800/60 backdrop-blur-md rounded-3xl border border-slate-700/50 dark:border-slate-700/50 p-8 shadow-xl animate-fadeIn">
								...
								<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
									...
									<div className="bg-slate-700/30 dark:bg-slate-700/30 rounded-2xl p-6 border border-slate-600 dark:border-slate-600 text-center hover:bg-slate-700/50 dark:hover:bg-slate-700/50 transition">
										...
										<div className="text-gray-400 dark:text-gray-400 text-sm uppercase font-bold mb-1">
											{t("profileView.stats.vsBots")}
										</div>
									...
									<div className="bg-slate-700/30 dark:bg-slate-700/30 rounded-2xl p-6 border border-slate-600 dark:border-slate-600 text-center hover:bg-slate-700/50 dark:hover:bg-slate-700/50 transition">
										...
										<div className="text-gray-400 dark:text-gray-400 text-sm uppercase font-bold mb-1">
											{t("profileView.stats.tournaments")}
										</div>
										<div className="text-3xl font-bold text-white dark:text-white">
											{stats.tournamentsWon}{" "}
											<span className="text-sm text-gray-500 dark:text-gray-500 font-normal">
												{t("profileView.stats.won")}
											</span>
										</div>
									</div>
								</div>
									...
									{matchHistory.length > 0 ? (
										<>
											{matchHistory.map((match) => (
												<div
													key={match.id}
													className={`group relative p-4 rounded-2xl border transition-all duration-300 hover:scale-[1.01] overflow-hidden ${
														match.isWinner
														...
														<div className="flex items-center gap-4">
															<div className="relative">
																{match.opponent
																	.isBot ? (
																	<div
																		className="w-12 h-12 rounded-full bg-slate-700 dark:bg-slate-700 border border-slate-500 dark:border-slate-500 flex items-center justify-center text-xl"
																		aria-label="Bot"
																	>
																		🤖
																	</div>
															...
															<div>
																<div className="flex items-center gap-2">
																	...
																	>
																		{match.isWinner
																			? t(
																					"profileView.history.win"
																			  )
																			: t(
																					"profileView.history.loss"
																			  )}
																	</span>
																	<span className="text-gray-400 dark:text-gray-400 text-sm">
																		{t(
																			"profileView.history.vs"
																		)}
																	</span>
																	<span className="text-white dark:text-white font-bold text-lg">
																		{match
																			...
																			.isBot
																			? `${t(
																					"profileView.history.bot"
																			  )} (${t(
																					`profileView.history.difficulty.${
																						match
																							.opponent
																							.botDifficulty ||
																						"medium"
																			...
																			: match
																					...
																					.name ||
																			  t(
																					"profileView.history.unknownPlayer"
																			  )}
																	</span>
																</div>
												...
												<div className="flex justify-center mt-8">
													<button
														...
														aria-label={
															historyLoading
																? t(
																		"profileView.history.loading"
																  )
																: t(
																		"profileView.history.loadMore"
																  )
														}
													>
														{historyLoading ? (
															<>
																<div
																	className="animate-spin w-4 h-4 border-2 border-white/50 border-t-white rounded-full"
																	aria-hidden="true"
																></div>
																{t(
																	"profileView.history.loading"
										...
										<div className="text-center py-20 bg-slate-900/30 dark:bg-slate-900/30 rounded-2xl border border-dashed border-slate-700 dark:border-slate-700">
											<div
												className="text-5xl mb-4 grayscale opacity-50"
												aria-hidden="true"
											>
												📜
											</div>
											<h4 className="text-xl font-bold text-gray-400 dark:text-gray-400 mb-2">
												{t("profileView.history.empty")}
											</h4>
											<p className="text-gray-500 dark:text-gray-500">
												{t(
													"profileView.history.noMatches"
												)}
											</p>
										</div>
									)}
