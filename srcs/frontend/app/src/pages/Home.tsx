      ...
      >
        <div className={`relative z-10 min-h-screen transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          ...
          <div className="text-center max-w-6xl mx-auto px-6 flex flex-col items-center justify-center min-h-screen">
            ...
            <div className={`grid gap-8 max-w-5xl mx-auto ${isAuthenticated ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-4' : 'grid-cols-1 md:grid-cols-2 lg:grid-cols-4'
              }`}>

              {!isAuthenticated && (
                <>
                  {/* Bouton Connexion */}
                  <Link to={"/Connection"} className="action-btn-aesthetic">
                  ...
                  {/* Bouton Inscription */}
                  <Link to={"/Registration"} className="action-btn-aesthetic">
                    <div className="flex flex-col items-center gap-3">
