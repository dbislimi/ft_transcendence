			...
			<div className="relative min-h-screen overflow-hidden">
					...
					<div className="max-w-6xl mx-auto px-6">
						<div className="text-center mb-16">
							...
							<p className="text-xl md:text-2xl text-gray-300 font-light max-w-3xl mx-auto">
								{t("about.subtitle") ||
									"Decouvrez les talents derriere Transcendence"}
							</p>
						</div>
				...
				{isPopupOpen && selectedMember && (
					<div className="fixed inset-0 z-50 flex items-center justify-center p-4">
						...
						<div
							className={`relative bg-gradient-to-br from-slate-800 to-purple-900 rounded-2xl border border-purple-500/30 max-w-2xl w-full transform transition-all duration-300 ${
								isPopupOpen
							...
							<div className="relative p-8">
								...
								<div className="mb-6">
									<h3 className="text-xl font-semibold text-white mb-3">
										{t("about.pathway") || "Parcours"}
									</h3>
									<p className="text-gray-300 leading-relaxed">
										{t(
											`about.descriptions.${selectedMember.descriptionKey}`
