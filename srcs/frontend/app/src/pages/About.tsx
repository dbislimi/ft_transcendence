...
const teamMembers: TeamMember[] = [
  {
    ...
    description: "Développeur passionné par les technologies web modernes et l'innovation. Spécialisé dans le développement full-stack avec une approche créative et méthodique.",
    links: {
  ...
  },
  {
    ...
    description: "Expert en développement backend et en architecture logicielle. Passionné par la performance et la scalabilité des applications.",
    links: {
  ...
  },
  {
    ...
    description: "Développeur frontend créatif avec un œil pour le design et l'expérience utilisateur. Spécialisé dans les interfaces modernes et réactives.",
    links: {
  ...
  },
  {
    ...
    description: "Développeur polyvalent avec une expertise en DevOps et en développement d'applications robustes. Passionné par l'automatisation et l'efficacité.",
    links: {
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-300 font-light max-w-3xl mx-auto">
              Découvrez les talents derrière Transcendence
            </p>
          </div>
              ...
              >
               ...
               <div className="flex items-center space-x-6 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Développeur Full-Stack</p>
                </div>
              </div>
              
              {/* Description */}
              <div className="mb-6">
                <h3 className="text-xl font-semibold text-white mb-3">Parcours</h3>
