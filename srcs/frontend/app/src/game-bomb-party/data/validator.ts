/**
 * Minimal validator for basic client-side validation (no dictionary)
 * For immediate user feedback before backend validation
 */
...
/**
 * Basic local validation without dictionary lookup
 * Used for immediate user feedback before backend validation
 */
