...
export default function Header() {
	...
	return (
		<header
			className="relative z-70 w-full backdrop-blur-xl border-b"
			style={{
				...
				<div className="flex justify-between items-center">
					<div className="flex items-center gap-4">
						{isAuthenticated ? (
							<>
								...
								<Link to="/stats" className="nav-btn-aesthetic">
									<span className="label-aesthetic">
										{t("nav.stats")}
									</span>
								</Link>
					...
					<Link to={"/"} className="group relative">
						<div className="relative">
							...
							<div
								className="absolute -top-1 -right-1 w-2 h-2 bg-purple-400 rounded-full animate-ping opacity-75"
