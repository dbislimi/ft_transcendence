...
export default function ShopModal({ isOpen, onClose }: ShopModalProps) {
	...
	const [backgroundTab, setBackgroundTab] = useState<"light" | "dark">(
	...
	const filteredBackgrounds =
		backgroundTab === "light" ? lightBackgrounds : darkBackgrounds;
						...
						<div className="space-y-6">
							...
							<div className="flex items-center justify-end mb-4">
								<span className="text-sm text-gray-400">
									...
									{t("shop.items.available") || "disponibles"}
								</span>
							</div>
