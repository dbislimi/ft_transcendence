...
function handleLobbyCreate(connection, payload) {
...
function handleLobbyJoin(connection, payload) {
...
function handleBonusActivate(connection, payload) {
...
function sendError(connection, message, code) {
    sendMessage(connection, {
        event: 'bp:error',
        payload: {
            message,
